...
namespace Globals {
	...
	// Patch
	inline BYTE gameinfo_pattern[] = { 0x74, 0x00, 0x80, 0x3D, 0x53, 0x2D, 0x31, 0x02 };
	inline BYTE gameinfo_replace[] = { 0xEB };
	// Revert
	inline BYTE gameinfo_revert_pattern[] = { 0x74, 0x00, 0x80, 0x3D, 0x53, 0x2D, 0x31, 0x02 };
	inline BYTE gameinfo_revert_replace[] = { 0xEB };
