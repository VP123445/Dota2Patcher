...
namespace Globals {
	...
	inline BYTE sv_cheats_pattern[] =			{ 0x84, 0xC0, 0x74, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x84, 0xC0, 0x75, 0x00, 0xE8 };
	inline BYTE sv_cheats_replace[] =			{ 0xA8, 0x00 };

	inline BYTE sv_cheats_revert_pattern[] =	{ 0xA8, 0x00, 0x74, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x84, 0xC0, 0x75, 0x00, 0xE8 };
	inline BYTE sv_cheats_revert_replace[] =	{ 0x84, 0xC0 };
}
